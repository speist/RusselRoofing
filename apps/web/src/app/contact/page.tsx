  ...
  return (
    <FloatingPageLayout>
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(/images/contact/contact-hero.jpeg)`,
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-white">Get a response within 24 hours</p>
              </div>
              <div className="text-center">
                <div className="bg-white/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <p className="text-sm text-white">See our work in your area</p>
              </div>
            </div>
          </div>
        </div>
